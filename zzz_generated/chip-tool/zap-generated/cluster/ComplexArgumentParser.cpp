...
CHIP_ERROR ComplexArgumentParser::Setup(const char * label,
                                        chip::app::Clusters::Messages::Structs::PresentMessageRequestStruct::Type & request,
                                        Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
    ...
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.messageID", "messageID",
                                                                  value.isMember("messageID")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.priority", "priority", value.isMember("priority")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.messageControl", "messageControl",
                                                                  value.isMember("messageControl")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.startTime", "startTime",
                                                                  value.isMember("startTime")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.duration", "duration", value.isMember("duration")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.messageText", "messageText",
                                                                  value.isMember("messageText")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("PresentMessageRequestStruct.responses", "responses",
                                                                  value.isMember("responses")));
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::Messages::Structs::PresentMessageRequestStruct::Type & request)
{
                                        ...
                                        Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("MessageStruct.responses", "responses", value.isMember("responses")));
